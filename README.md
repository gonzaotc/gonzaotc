...
Im currently working on a e-commerce 100% handcrafted with vanilla js, html and CSS. At this moment, im refactoring from vanilla CSS to Sass for better code organization and dark/light theme. Also conecting with crypto API to calculate the graphic cards mining profit in real time.
